...
class LSTMEncoder(FairseqEncoder):
    """LSTM encoder."""
    def __init__(
        self, dictionary=None, embed_dim=1, hidden_size=512, num_layers=1,
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        x = src_tokens.view(bsz, seqlen, 1)
...
class LSTMDecoder(FairseqIncrementalDecoder):
    ...
    def forward(self, prev_output_tokens, encoder_out_dict, incremental_state=None):
        ...
        # x = prev_output_tokens.view(bsz, seqlen, 1)
        x = F.dropout(x, p=self.dropout_in, training=self.training)
...
class LSTMModel(FairseqModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--dropout', type=float, metavar='D',default=0,
...
@register_model_architecture('lstm_signal', 'lstm_signal')
